...
let currentQuestion = 0, points = 0;
...
const loadQuestion = () => {
    ...
    for (let i = 0; i < options.length; i++) {
        ...
        optionsBlock === null || optionsBlock === void 0 ? void 0 : optionsBlock.insertAdjacentHTML('beforeend', option);
    }
};
const submitQuestion = () => {
    ...
    const isSelected = optionsBlock.querySelector('input[name="option"]:checked');
    if (!isSelected)
        return;
...
const showPoints = () => {
    ...
    questionBlock === null || questionBlock === void 0 ? void 0 : questionBlock.insertAdjacentText('beforeend', results);
